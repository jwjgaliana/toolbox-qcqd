...
def fchk2transition_density_cube(filename,cubman_version="cubman-g16",threshold=1/100,force_cubegen=True,force_recalc=True):
    ...
    logfile.write("Threshold for seleced pairs of NTO: {}\n".format(threshold))
...
if __name__=="__main__":
    ...
    filetagTransitionDensity,occupied_orbitals_weights,virtual_orbitals_weights=fchk2transition_density_cube(filename,threshold=threshold,force_cubegen=force_recalc,force_recalc=force_recalc)
