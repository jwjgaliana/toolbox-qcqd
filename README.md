...
- openmolcas_utilities
    ...
    - h5_to_DDM_CUB_from_trd1_rassi_via_NDO read rasscf.h5 and rassi.h5 to get transition density matrix, associated NTOs and ρ0i(r)
    - h5_to_TDM_CUB_from_trd1_rassi_via_NTO read rasscf.h5 and rassi.h5 to get density difference matrix, associated NDOs and $ρ_{0i}(\mathbf{r})$
